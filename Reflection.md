...
## What was the hardest error scenario to handle?

Scenario Number 3 which is validate the MIME Type of the file

## Which edge case surprised you most?

edge case 3 and edge case 2

## What's the difference between "it works" and "it's production-ready"?

basically the production ready handle it need to handle multiple scenario like user is offline, slow internet the image is corrupted for example what we did in scenario 3 display appropriate error messages while without these the app will work but not handling the edge cases and error message won't give any value to frontend

## Did you use AI for any part? If yes, which parts and did you understand what it generated?

No AI has been used to generate any code the AI just used for formatting md files
